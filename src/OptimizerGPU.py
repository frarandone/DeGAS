...
if __name__ == '__main__':
    ...
    for model_name, model in model_list.items():
        ...
        if n_traj:
            traj_set = generate_trajectories(orig_model, n_traj, model_params=true_params, device=device)
            # print(traj_set)
        ...
        params_dict = initialize_params(pars, device=device)
