...
class StateNode(CFGnode):
    ...
    def __str__(self):
        if self.smooth:
            return "StateNode<{},{},{},smoothed:{}>".format(
                self.name, self.cond, self.expr, self.smooth
            )
        else:
...
class TestNode(CFGnode):
    ...
    def __str__(self):
        if self.smooth:
            return "TestNode<{},{},smoothed:{}>".format(
                self.name, self.LBC, self.smooth
            )
        else:
...
class ObserveNode(CFGnode):
    ...
    def __str__(self):
        if self.smooth:
            return "ObserveNode<{},{},smoothed:{}>".format(
                self.name, self.LBC, self.smooth
            )
        else:
